...
加密市场常说的“四年周期”，核心来源于比特币的“减半机制（Halving）”。

比特币区块奖励每 210,000 个区块减半一次，约 4 年发生一次。
减半意味着：
- 新增供应减少
- 通胀率下降
- 抛压减弱
...
在历史上：
减半 → 供给减少 → 市场预期增强 → 牛市启动 → 高点形成 → 熊市回调 → 横盘整理 → 下一轮减半
...
但减半不是直接拉盘的按钮，
而是通过供需结构 + 市场预期 + 流动性环境共同作用。

---

### 三、超买与超卖

在周期运行过程中，市场会出现“情绪极端”阶段：
...
区块链的核心问题是：在没有中心机构的情况下，如何达成一致？

共识机制就是区块链网络中各节点就“谁来出块、账本状态是什么”达成一致的规则。
...
不同公链通过不同共识机制，在“不可能三角（安全、可扩展、去中心化）”之间做取舍。
...
在以太坊等支持智能合约的公链中，每一个操作都需要计算资源，因此需要支付费用。
